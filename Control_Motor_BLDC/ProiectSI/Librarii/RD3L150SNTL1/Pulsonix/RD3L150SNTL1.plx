...
(library Library_1
	...
	(patternDef "RD3P175SNFRATL" (originalName "RD3P175SNFRATL")
		...
		(layerContents (layerNumRef 28)
			(line (pt -3.3 4.25) (pt 3.3 4.25) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.3 4.25) (pt 3.3 -1.95) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.3 -1.95) (pt -3.3 -1.95) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.3 -1.95) (pt -3.3 4.25) (width 0.025))
		)
	...
	(compDef "RD3L150SNTL1" (originalName "RD3L150SNTL1") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "<Hyperlink>" "https://fscdn.rohm.com/en/products/databook/datasheet/discrete/transistor/mosfet/rd3l150sntl-e.pdf")
		(attr "<STEP Filename>" "RD3L150SNTL1.stp")
		(attr "<STEP Offsets>" "X=195.59;Y=-26.35;Z=-84.23")
